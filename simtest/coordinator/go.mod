module source.quilibrium.com/quilibrium/monorepo/simtest/coordinator
...
require (
	...
	source.quilibrium.com/quilibrium/monorepo/protobufs v0.0.0 // indirect
	source.quilibrium.com/quilibrium/monorepo/types v0.0.0 // indirect
